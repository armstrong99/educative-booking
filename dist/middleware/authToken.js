...
exports.default = (function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _api, _a, user_id, email, token, data, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _api = "https://rivon-bus.herokuapp.com/verify/";
                _a = req.body, user_id = _a.user_id, email = _a.email;
            ...
            case 2:
                ...
                if (data === null || data === void 0 ? void 0 : data._id) {
                    ...
                    throw new Error("invalid token, user may not be logged in");
                return [3 /*break*/, 4];
            case 3:
                error_1 = _b.sent();
                console.log(error_1);
